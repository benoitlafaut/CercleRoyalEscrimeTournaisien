...
{
    [RoutePrefix("NewPoules")]
    public class NewPoulesController : Controller
    {
       
        [OutputCache(Location = OutputCacheLocation.None, NoStore = true)]
        public ActionResult NewPoules()
        {
        ...
        public ActionResult CalculerLeRoundSuivant(string roundSelected, string pouleSelected, string dateDuJourWithoutDay)
        {
            ...
            return Json(new { redirectUrl = Url.Action("Poules", "NewPoules") });
        }
        ...
        public ActionResult ChangeDateDeLaPoule(string dateDeLaPouleSelected)
        {
            ...
            return RedirectToAction("AfficherLesPoules", "NewPoules");          
        }
        ...
        public ActionResult AddTireursSelectedToPoule(MyRequestToSaveInPoule myRequestToSaveInPoule)
        {
            ...
            return Json(new { redirectUrl = Url.Action("AfficherLesPoules", "NewPoules") });
        }
        ...
        public ActionResult AddScoreEliminationDirecte(MyRequestEliminationDirecteToSaveInPoule myRequestEliminationDirecteToSaveInPoule)
        {
            ...
            return Json(new { redirectUrl = Url.Action("ChangeRoundPourShowEliminationsDirectes", "NewPoules", new { roundSelected = myRequestEliminationDirecteToSaveInPoule.Round, PouleSelected = myRequestEliminationDirecteToSaveInPoule.PouleSelected }) });
        }
        [HttpPost]
