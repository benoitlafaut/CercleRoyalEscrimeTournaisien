        ...
        public Categorie Categorie {
            get
            {
                switch (TireurSelectionne.UserNameIndex)
                {
                    ...
                    case IndexTireurConstantes.TireurIndex.GabrielSegard:
                        GabrielSegard_NosCoursTireurSelectionneModel gabrielSegard_NosCoursTireurSelectionneModel = new GabrielSegard_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                        return (gabrielSegard_NosCoursTireurSelectionneModel.Categorie);
                    ...
                    case IndexTireurConstantes.TireurIndex.EleonoraColpaert :
                        EleonoraColpaert_NosCoursTireurSelectionneModel eleonoraColpaert_NosCoursTireurSelectionneModel = new EleonoraColpaert_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                        return (eleonoraColpaert_NosCoursTireurSelectionneModel.Categorie);
                    default:
            ...
            get
            {
                ...
                remarquesPourToutesLesPoules.AddRange(
                    new List<RemarqueParDate>() {
                          new RemarqueParDate()
                    {
                        DateRemarque = new DateTime(2026, 4, 6),
                        Arme = TypeArme.Sabre,
                        IsSwitchToShowDossierPhotos = true,
                        SwitchToDossierPhotosGuid = GuidConstantesImages.GuidMontageEpee,
                        Titre = "Le montage d'une épée.",
                         ...
                         new RemarqueParDate()
                    {
                        ...
                        Arme = TypeArme.Sabre,
                        IsSwitchToShowDossierPhotos = true,
                        SwitchToDossierPhotosGuid = GuidConstantesImages.GuidRonseFévrier2026,
                        Titre = "Les résultats de Ronse en photo (Abel, Amel, Anaëlle, Baptiste, Eliot, Félix, Lili, Maé, Martin, Oscar)",
                        RemarquesData = new List<RemarqueData>()
                        {
                            new RemarqueData()
                            {
                                Remarque = "Les normes ont été affichées",
                                     PointPositifNégatifObservation = PointPositifNégatifObservation.Observation,
                           }
                        }
                    },
                        new RemarqueParDate()
                    {
                        DateRemarque = new DateTime(2026, 2, 7),
                        Arme = TypeArme.Sabre,
                        IsShowPartialView = true,
                        PartialViewToShow = PartialViewNames.NormesMatériel,
                        Titre = "Les normes d'un tireur pour les compétitions",
                        RemarquesData = new List<RemarqueData>()
                        {
                            new RemarqueData()
                            {
        ...
        public List<RemarqueParDate> RemarquesParDate { 
            get
            {
                ...
                switch (TireurSelectionne.UserNameIndex)
                {
                    ...
                    case IndexTireurConstantes.TireurIndex.GabrielSegard:
                        GabrielSegard_NosCoursTireurSelectionneModel gabrielSegard_NosCoursTireurSelectionneModel = new GabrielSegard_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                        return TrierParDate(gabrielSegard_NosCoursTireurSelectionneModel.RemarquesParDateTireur);
                    case IndexTireurConstantes.TireurIndex.EstebanDuthye:
                       EstebanDuthye_NosCoursTireurSelectionneModel estebanDuthye_NosCoursTireurSelectionneModel = new EstebanDuthye_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                    ...
                    case IndexTireurConstantes.TireurIndex.EleonoraColpaert:
                        EleonoraColpaert_NosCoursTireurSelectionneModel eleonoraColpaert_NosCoursTireurSelectionneModel = new EleonoraColpaert_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                        return TrierParDate(eleonoraColpaert_NosCoursTireurSelectionneModel.RemarquesParDateTireur);
                    default:
        ...
        public IDictionary<string, string> Poules
        {
            get
            {
                ...
                switch (TireurSelectionne.UserNameIndex)
                {
                    ...
                    case IndexTireurConstantes.TireurIndex.GabrielSegard:
                        GabrielSegard_NosCoursTireurSelectionneModel gabrielSegard_NosCoursTireurSelectionneModel = new GabrielSegard_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                        return gabrielSegard_NosCoursTireurSelectionneModel.GetPoules.OrderByDescending(x => x.Value).ToDictionary(x => x.Key, y => y.Value);
                    case IndexTireurConstantes.TireurIndex.EstebanDuthye :
                        EstebanDuthye_NosCoursTireurSelectionneModel estebanDuthye_NosCoursTireurSelectionneModel = new EstebanDuthye_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                    ...
                    case IndexTireurConstantes.TireurIndex.EleonoraColpaert:
                        EleonoraColpaert_NosCoursTireurSelectionneModel eleonoraColpaert_NosCoursTireurSelectionneModel = new EleonoraColpaert_NosCoursTireurSelectionneModel(TireurSelectionne) { };
                        return eleonoraColpaert_NosCoursTireurSelectionneModel.GetPoules.OrderByDescending(x => x.Value).ToDictionary(x => x.Key, y => y.Value);
                    default:
                        return new Dictionary<string, string>() { };
                }
            }
