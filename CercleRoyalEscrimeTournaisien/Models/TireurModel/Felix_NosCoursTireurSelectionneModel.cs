...
namespace CercleRoyalEscrimeTournaisien
{
    ...
    public class Felix_NosCoursTireurSelectionneModel : NosCoursTireurSelectionneModel
    {
        private DateTime DateDeNaissance
        {
            get
            {
                return new DateTime(2013, 10, 17);
            }
        }
                ...
                remarquesParDateTireur.AddRange(new List<RemarqueParDate>()
                {
                     ...
                     new RemarqueParDate()
                    {
                        ...
                        RemarquesData = new List<RemarqueData>()
                        {
                            new RemarqueData()
                            {
                                ...
                                Remarque="Tu bouges beaucoup vers l'avant, tu vas chercher les touches, prends ton temps davantage pour utiliser les 3 minutes. tu ne dois pas vite vite terminer ton match. et note dans ton carnet tout ce qui marche. je suis sur que si tu le notais tu pourrais te rappeler de plus de choses qui marchent selon que tu tires contre l'un ou l'autre.",
                            },
                            new RemarqueData()
                            {
                                PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                                Remarque="Si une fente ne marche pas, fais un marché fente. Généralement tu arrives trop court car tu ne fais qu'une seule fente. rajoute un marché ou un déplacement plus important pour te rapprocher de ton adversaire.",
                            },
                            new RemarqueData()
                            {
                               PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                               Remarque="Prends ton temps après chaque touche surtout si tu te fais toucher pour analyser pourquoi tu as été touché, tu as tendance à aller trop vite et l'autre en profite et fait généralement la même chose",
                            },
                            new RemarqueData()
                            {
                                PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                                Remarque="lors de la retraite, le bras se fléchit bien pour faire un contre le sixte facilement. tu laisses trop souvent ton bras allongé ou à moitié allongé.",
                            },
                            new RemarqueData()
                            {
                                PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                                Remarque="Ta main armée est souvent trop haute par rapport à ton coude.",
                                Frequency = 5
                            },
                            new RemarqueData()
                            {
                                PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                                Remarque="On ne dit pas problème de branchement quand on arbitre... on le résoud en m'appelant ou Rémi ou Fabrice.. mais là quand cà sonne régulièrement, c'est le fil de corps à changer.",
                            },
                            new RemarqueData()
                            {
                                Remarque="Quand un tireur touche la coquille adverse, l'autre a fait une parade.",
                                    PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                            },
                        }
                    },
                    new RemarqueParDate()
                    {
                        ...
                        RemarquesData = new List<RemarqueData>()
                        {
                            ...
                            {
                                PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif ,
                                Remarque="Quand tu fais une parade circulaire ou contre le sixte, ta lame vise les mouettes. Essaie de jouer plus fin, plus petit; au plus tes gestes sont petits, au mieux c'est pour la précision. Et toujours quand il s'agit d'un grand de te cantonner à la manchette voire la saignée pas plus loin."
                            },
                        }
                    },
                    new RemarqueParDate()
                    {
                        ...
                        RemarquesData = new List<RemarqueData>()
                        {
                            new RemarqueData()
                            {
                                ...
                                PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                                Remarque="La pointe est trop haute. elle doit toujours être en direction de la manchette"
                            },
                            new RemarqueData()
                            {
                                //HasPointPositif=false,
                                 PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif,
                               Remarque="Tourner le dos à son adversaire est sanctionnable."
                            },
                            new RemarqueData()
                            {
                               // HasPointPositif=false,
                                PointPositifNégatifObservation = PointPositifNégatifObservation.Négatif ,
                                Remarque="Si tu tires contre plus grand que toi, à l'allonge du bras, lève la coquille pour te diriger vers la manchette dessous et ne vise pas le ventre. S'il est plus rapide que toi, il va essayer de te toucher à la manchette dessous. Prends le fer en pronation et touche à la cuisse."
                            },
                        }
                    },
                    new RemarqueParDate()
