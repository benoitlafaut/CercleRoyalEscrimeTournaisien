...
namespace CercleRoyalEscrimeTournaisien
{
    public class Albums
    {
        ...
        {
            get {
                return ListeDesAlbumsStatic.Where(x => x.NumeroAlbum == Models.MainModel.NumeroAlbumCurrent).First().NomAlbum;
            }
        }
        public List<Album> ListeDesAlbumsStatic;
        ...
        {
            switch (Models.MainModel.NumeroAlbumCurrent)
            {
                case 1:
                    return 8;
                case 2:
