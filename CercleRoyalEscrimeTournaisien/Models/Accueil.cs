...
namespace CercleRoyalEscrimeTournaisien
{
    public class Accueil
    {
        public Accueil()
        {
            ...
            Horaires += Environment.NewLine + "Voici le plan: " + "<i class='fa fa-binoculars' style='font-size: 20px;color: darkkhaki;text-shadow: 1px 1px 1px blue;' onclick='showPopup(" + "\"plan.jpg\"" + ")'></i>";
