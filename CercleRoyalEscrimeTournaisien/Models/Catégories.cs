...
namespace CercleRoyalEscrimeTournaisien
{
    public class Categories
    {
        ...
        {
            Normes = new Normes();
            Title = "Les catégories pour la saison 2026-2027";
            ...
            RowsOfCol_5 = new List<string>() { "Année de naissance", "2016-2017", "2014-2015", "2012-2013", "2010-2011", "2007-2009", "2004-2006", "à partir de 2006", "1977-1986", "1967-1976", "1957-1966", "1926-1956" };
        }
    }    
}