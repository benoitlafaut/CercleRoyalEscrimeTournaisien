        ...
        public JoursDePrésence ChargerPresences()
        {
            JoursDePrésence joursDePrésence = new JoursDePrésence()
            {
                ...
                JourDePrésence = new List<JourDePrésence>()
                {
                     new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,6,8),
                ...
                //GuidConstantes.GuidRomainBelbenoit
                     ...
                     new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,6,6),
                         EscrimeurId = new List<Guid>()
                         {
                 GuidConstantes.GuidMartinSiu,
                GuidConstantes.GuidFélixTrannoy,
                ...
                GuidConstantes.GuidRomainBracquart
                       ...
                       new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,6,4),
                         EscrimeurId = new List<Guid>()
                         {
                 GuidConstantes.GuidMartinSiu,
                GuidConstantes.GuidFélixTrannoy,
                ...
                GuidConstantes.GuidRomainBracquart
                        ...
                        new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,6,1),
                         EscrimeurId = new List<Guid>()
                         {
                     GuidConstantes.GuidMartinSiu,
                //GuidConstantes.GuidFélixTrannoy,
                ...
                //GuidConstantes.GuidArthurCouturiaux
                      ...
                      new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,30),
                         EscrimeurId = new List<Guid>()
                         {
                              GuidConstantes.GuidMartinSiu,
                //GuidConstantes.GuidFélixTrannoy,
                ...
                //GuidConstantes.GuidArthurCouturiaux
                     ...
                     new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,28),
                         EscrimeurId = new List<Guid>()
                         {
                GuidConstantes.GuidMartinSiu,
                GuidConstantes.GuidFélixTrannoy,
                ...
                //GuidConstantes.GuidArthurCouturiaux
                    ...
                    new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,25),
                         EscrimeurId = new List<Guid>()
                         {
                ...
                //GuidConstantes.GuidArthurCouturiaux
                       ...
                       new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,23),
                         EscrimeurId = new List<Guid>()
                         {
                                  GuidConstantes.GuidMartinSiu,
                GuidConstantes.GuidFélixTrannoy,
                ...
                //GuidConstantes.GuidArthurCouturiaux
                     ...
                     new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,21),
                         EscrimeurId = new List<Guid>()
                         {
                   GuidConstantes.GuidMartinSiu,
                GuidConstantes.GuidFélixTrannoy,
                ...
                GuidConstantes.GuidArthurCouturiaux
                      ...
                      new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,18),
                         EscrimeurId = new List<Guid>()
                         {
                    //GuidConstantes.GuidMartinSiu,
                GuidConstantes.GuidFélixTrannoy,
                ...
                //GuidConstantes.GuidArthurCouturiaux
                      ...
                      new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,16),
                         EscrimeurId = new List<Guid>()
                         {
                            GuidConstantes.GuidMartinSiu,
                            GuidConstantes.GuidFélixTrannoy,
                      ...
                      new JourDePrésence()
                      {
                         DatePrésence = new DateTime(2025,5,14),
                         EscrimeurId = new List<Guid>()
                         {
                            //GuidConstantes.GuidMartinSiu,
                            GuidConstantes.GuidFélixTrannoy,
        ...
        public void Add_Paiements_Razanajao_Fabrice(string period, List<MembreData> Membres)
        {
            ...
            Membres.Where(x => x.GuidId == GuidConstantes.GuidFabriceRazanajao && x.Période == period).FirstOrDefault().Paiement =
                new Paiement()
                {
                    ...
                    IsCotisationCarte5 = true,
                    IsCotisationEnOrdre = true,
                    IsFicheSignaletiqueEnOrdre = true,
                    IsLicenceEnOrdre = true,
                    IsLocationMatérielEnOrdre = true,

                    PaiementsEffectues = new List<string>() { "170 euros", "50 euros","50 euros", "50 euros", "50 euros" },
                    SeancesGratuites = new List<DateTime>()
                    {
                    },
                    IsMatérielLoue = true
        ...
        public void Add_Paiements_Vercouter_Raedwald(string period, List<MembreData> Membres)
        {
            ...
            Membres.Where(x => x.GuidId == GuidConstantes.GuidRaedwaldVercouter && x.Période == period).FirstOrDefault().Paiement =
                new Paiement()
                {
                    ...
                    PaiementsEffectues = new List<string>() { "95 euros", "50 euros", "25 euros", "50 euros", "50 euros" },
                    SeancesGratuites = new List<DateTime>()
                    {
